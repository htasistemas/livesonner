...
$string['error:imagemagickmissing'] = 'A geração das imagens dos certificados requer a extensão Imagick do PHP.';
$string['error:imagemagickrender'] = 'Não foi possível renderizar a imagem do certificado. Entre em contato com o administrador do site.';
