...
$string['recordedvideo'] = 'Vídeo gravado da aula';
$string['recordedvideo_help'] = 'Após finalizar a aula, faça o upload da gravação para que os alunos possam assistir mais tarde.';
...
$string['novideoavailable'] = 'Nenhuma gravação disponível.';
...
$string['videoavailableafterfinish'] = 'Após finalizar a aula, volte aqui para enviar a gravação.';
