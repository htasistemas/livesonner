...
$string['finishsuccesswithcertificates'] = 'The class has been finished and {$a} certificate(s) were issued.';
$string['finishsuccessnocertificates'] = 'The class has been finished, but no certificates could be issued.';
$string['finishalready'] = 'The class had already been finished.';
$string['filearea_certificates'] = 'Issued certificates';
$string['error:certificatetemplate'] = 'The certificate template could not be loaded. Please contact the site administrator.';
$string['error:imagemagickmissing'] = 'Generating certificate images requires the Imagick PHP extension.';
$string['error:imagemagickrender'] = 'The certificate image could not be rendered. Please contact the site administrator.';
...
$string['privacy:metadata:livesonner_certificates'] = 'Stores certificates issued for completed live classes.';
$string['privacy:metadata:livesonner_certificates:livesonnerid'] = 'Live class for which the certificate was issued.';
$string['privacy:metadata:livesonner_certificates:userid'] = 'User who received the certificate.';
$string['privacy:metadata:livesonner_certificates:filename'] = 'Name of the generated certificate file.';
$string['privacy:metadata:livesonner_certificates:timecreated'] = 'Time when the certificate was issued.';
$string['privacy:metadata:livesonner_certificates:timemodified'] = 'Last modification time for the certificate record.';
