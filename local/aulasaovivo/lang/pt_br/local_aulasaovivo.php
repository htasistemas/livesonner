...
$string['manualcertificate:file'] = 'Certificado em PNG';
...
$string['manualcertificate:missingfile'] = 'Envie o arquivo PNG do certificado antes de salvar.';
$string['manualcertificate:invalidfiletype'] = 'Apenas arquivos PNG são permitidos para certificados.';
