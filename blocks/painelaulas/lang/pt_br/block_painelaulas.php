...
$string['pluginname'] = 'Painel de aulas ao vivo';
$string['painelaulas:addinstance'] = 'Adicionar um novo bloco Painel de aulas ao vivo';
$string['painelaulas:myaddinstance'] = 'Adicionar o bloco Painel de aulas ao vivo ao Meu painel';
$string['painelaulas:view'] = 'Visualizar o bloco Painel de aulas ao vivo';
$string['pageheading'] = 'Painel de aulas ao vivo';
...
$string['settings_enablefallback_desc'] = 'Quando a integração não estiver disponível, o painel exibirá dados fictícios para validação visual.';
$string['privacy:metadata'] = 'O bloco Painel de aulas ao vivo não armazena dados pessoais além do necessário para exibir inscrições ativas.';
